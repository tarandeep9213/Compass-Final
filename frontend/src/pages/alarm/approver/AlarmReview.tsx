...
export default function AlarmReview({ userName: _userName, ctx, onNavigate }: Props) {
  ...
  const handleRejectConfirm = async () => {
    ...
    try {
      ...
      toast.success('Test rejected. Tester will be notified.')
  ...
  return (
    <div>
      ...
      {/* ── Approval action card (only for SUBMITTED) ── */}
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 13, color: 'var(--ts)', marginBottom: 12 }}>
              Please provide a reason for rejection. The tester will be notified.
            </p>
            <div className="f-field">
