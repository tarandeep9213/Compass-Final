...
const EVENT_LABELS: Record<string, string> = {
  ...
  MISSED_SUBMISSION_LOGGED:      'Missed Submission Logged',
  // Verifications
  VERIFICATION_SCHEDULED:        'Verification Scheduled',
  VERIFICATION_COMPLETED:        'Verification Completed',
  VERIFICATION_MISSED:           'Verification Missed',
  ...
  ADMIN_RESET_EXECUTED:          'Admin Reset Executed',
  // Locations
...
const EVENT_COLORS: Record<string, string> = {
  ...
  SUBMISSION_UPDATED:            '#e0f2fe',
  SUBMISSION_DELETED:            '#fff1f2',
  SUBMISSION_APPROVED:           '#f0fdf4',
  SUBMISSION_REJECTED:           '#fff1f2',
  MISSED_SUBMISSION_LOGGED:      '#fff7ed',
  // Verifications — purples/yellows
  VERIFICATION_SCHEDULED:        '#fdf4ff',
  VERIFICATION_COMPLETED:        '#f0fdf4',
  VERIFICATION_MISSED:           '#fff1f2',
  VERIFICATION_CANCELLED:        '#fff7ed',
  // Users — teals
  USER_LOGIN:                    '#f0fdfa',
  USER_CREATED:                  '#f0f9ff',
  USER_UPDATED:                  '#e0f2fe',
  ...
  PASSWORD_RESET_REQUESTED:      '#fdf4ff',
  PASSWORD_RESET_OTP_VERIFIED:   '#fdf4ff',
  PASSWORD_CHANGED:              '#fdf4ff',
  ADMIN_RESET_EXECUTED:          '#fff1f2',
  // Locations — greens
