...
export interface ComplianceRules {
  ...
  biannual: {
    ...
    escalation: {
      tier1: { daysOverdue: number; recipients: string[] };
      tier2: { daysOverdue: number; recipients: string[] };
      tier3: { daysOverdue: number; recipients: string[] };
    };
  };
  notifications: {
    enableEmail: boolean;
...
export const COMPLIANCE_RULES: ComplianceRules = {
  ...
  biannual: {
    ...
    escalation: {
      tier1: { daysOverdue: 7,  recipients: ['tester', 'approver'] },
      tier2: { daysOverdue: 14, recipients: ['tester', 'approver', 'regional'] },
      tier3: { daysOverdue: 30, recipients: ['tester', 'approver', 'regional', 'dgm'] },
    },
  },
  notifications: {
    enableEmail: true,
...
export const ALARM_BUILDINGS: AlarmBuilding[] = [
  // -- Midwest (4) --
  {
    ...
    status: 'active',
    assignedTesters: ['U6', 'U7'],
    assignedApprover: 'U10',
  },
  {
    id: 'bld-madison',
