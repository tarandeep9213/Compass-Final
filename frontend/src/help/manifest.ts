  ...
  admin: [
    {
      ...
      videos: [
        ...
        { label: 'Locations',     url: '/help/videos/admin/locations.mp4' },
        { label: 'Users',         url: '/help/videos/admin/users.mp4' },
        { label: 'Import',        url: '/help/videos/admin/import-roster.mp4' },
        { label: 'Reports',       url: '/help/videos/admin/reports.mp4' },
        { label: 'Cash Trends',   url: '/help/videos/admin/cash-trends.mp4' },
        { label: 'Reasonableness',url: '/help/videos/admin/reasonableness.mp4' },
      ],
    },
