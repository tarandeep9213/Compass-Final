...
const DEFAULT_USERS: User[] = [
  ...
  { id: 'U10', name: 'Jamie Roberts',  email: 'jamie.roberts@compass.com',  role: 'regional-controller',  locationIds: [], active: true },
  { id: 'U11', name: 'Kyle Decker',    email: 'kyle.decker@compass.com',    role: 'regional-controller',  locationIds: [], active: true },
  { id: 'U12', name: 'Laura Davis',    email: 'laura.davis@compass.com',    role: 'regional-controller',  locationIds: [], active: true },
  { id: 'U6',  name: 'Chris Controller', email: 'controller@compass.com',   role: 'controller',           locationIds: [], active: true },
  { id: 'U7',  name: 'Diana DGM',      email: 'dgm@compass.com',            role: 'dgm',                  locationIds: [], active: true },
]
// Normalize any stale underscore roles written by the old syncUsers() bug
// e.g. 'regional_controller' → 'regional-controller'
function normalizeRole(r: string): User['role'] {
  return (r.replace(/_/g, '-') as User['role'])
}
const _rawUsers = loadStored<User>('compass_users', DEFAULT_USERS)
_rawUsers.forEach(u => { u.role = normalizeRole(u.role) })
export const USERS: User[] = _rawUsers
