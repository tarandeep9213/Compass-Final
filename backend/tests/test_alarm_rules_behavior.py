...
def reset_rules_to_permissive(client):
    ...
    token = _auth(client, "alarmadmin@alarm.compass.com")
...
class TestEscalationTiersFromRules:
    ...
    def test_overdue_includes_tier_field(self, client, alarm_admin_token):
        _building(client, alarm_admin_token, "TierField Check")
    ...
    def test_tier_changes_with_rules(self, client, alarm_admin_token):
        """Change escalation thresholds and verify tier assignment changes."""
        bid = _building(client, alarm_admin_token, "TierRules Change")

        # Set tight thresholds: tier1=1 day before, tier2=0 days after, tier3=1 day after
        _set_rules(client, alarm_admin_token, escalation={
    ...
    def test_never_tested_is_tier_3(self, client, alarm_admin_token):
        """A building that was never tested should be tier 3 (most urgent)."""
        bid = _building(client, alarm_admin_token, "NeverTested Tier3")
...
class TestRequireAllZonesTested:
    ...
    def test_submit_blocked_with_untested_zones(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_all_zones_tested=True)

        bid = _building(client, alarm_admin_token, "ReqZones Block")
    ...
    def test_submit_ok_with_all_tested(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_all_zones_tested=True, require_report_upload=False)

        bid = _building(client, alarm_admin_token, "ReqZones OK")
        z1 = _zone(client, alarm_admin_token, bid, 1, "Door")
        z2 = _zone(client, alarm_admin_token, bid, 2, "Panic")
        tid = _test(client, alarm_tester_token, bid)
    ...
    def test_submit_ok_with_issue_found(self, client, alarm_admin_token, alarm_tester_token):
        """ISSUE_FOUND counts as tested (zone was physically tested, just had a problem)."""
        _set_rules(client, alarm_admin_token, require_all_zones_tested=True, require_report_upload=False)

        bid = _building(client, alarm_admin_token, "ReqZones Issue")
        z1 = _zone(client, alarm_admin_token, bid, 1, "Door")
        tid = _test(client, alarm_tester_token, bid)
    ...
    def test_submit_allowed_when_rule_disabled(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_all_zones_tested=False, require_report_upload=False)

        bid = _building(client, alarm_admin_token, "ReqZones Disabled")
        z1 = _zone(client, alarm_admin_token, bid, 1, "Door")
        tid = _test(client, alarm_tester_token, bid)
    ...
    def test_submit_no_zones_saved_blocked(self, client, alarm_admin_token, alarm_tester_token):
        """No zone results saved at all → should block if zones exist for building."""
        _set_rules(client, alarm_admin_token, require_all_zones_tested=True)

        bid = _building(client, alarm_admin_token, "ReqZones NoSave")
...
class TestRequireReportUpload:
    ...
    def test_submit_blocked_no_attachment(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_report_upload=True, require_all_zones_tested=False)

        bid = _building(client, alarm_admin_token, "ReqUpload Block")
        tid = _test(client, alarm_tester_token, bid)
    ...
    def test_submit_ok_with_attachment(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_report_upload=True, require_all_zones_tested=False)

        bid = _building(client, alarm_admin_token, "ReqUpload OK")
        tid = _test(client, alarm_tester_token, bid)
    ...
    def test_submit_allowed_when_rule_disabled(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_report_upload=False, require_all_zones_tested=False)

        bid = _building(client, alarm_admin_token, "ReqUpload Disabled")
        tid = _test(client, alarm_tester_token, bid)
...
class TestCombinedRules:
    ...
    def test_both_required_both_missing(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_all_zones_tested=True, require_report_upload=True)

        bid = _building(client, alarm_admin_token, "Both Missing")
        _zone(client, alarm_admin_token, bid, 1, "Door")
        tid = _test(client, alarm_tester_token, bid)
    ...
    def test_both_required_both_satisfied(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_all_zones_tested=True, require_report_upload=True)

        bid = _building(client, alarm_admin_token, "Both Satisfied")
        z1 = _zone(client, alarm_admin_token, bid, 1, "Door")
        tid = _test(client, alarm_tester_token, bid)
    ...
    def test_zones_ok_but_no_report_blocked(self, client, alarm_admin_token, alarm_tester_token):
        _set_rules(client, alarm_admin_token, require_all_zones_tested=True, require_report_upload=True)

        bid = _building(client, alarm_admin_token, "Zones OK No Report")
        z1 = _zone(client, alarm_admin_token, bid, 1, "Door")
        tid = _test(client, alarm_tester_token, bid)
